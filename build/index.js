...
var gtagInit = __webpack_require__(117);
...
var stageVersion = function () {
    var _ref = _asyncToGenerator(_regenerator2.default.mark(function _callee(type) {
        var alpha_max, version_new, reg, regRes;
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        version_new = '';
                        _context.next = 4;
                        return execCommandGetFirstTag(commands(type));

                    case 4:
                        tag_max = _context.sent;

                        if (tag_max) {
                            reg = new RegExp(type + '\\.?(\\d+)');
                            regRes = reg.exec(tag_max);
                        ...
                        return _context.abrupt('return', version_new);
    ...
    return function stageVersion(_x) {
...
var findVersion = function () {
    var _ref2 = _asyncToGenerator(_regenerator2.default.mark(function _callee2(type) {
        var command_type, reg;
            ...
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        ...
                        delimiter = delimiter || '.';
                        _context2.t0 = type;
                        _context2.next = _context2.t0 === 'major' ? 5 : _context2.t0 === 'minor' ? 5 : _context2.t0 === 'patch' ? 5 : _context2.t0 === 'base' ? 5 : 7;
                        break;
                    ...
                    case 8:
                        _context2.next = 10;
                        return execCommandGetFirstTag(commands(command_type));

                    case 10:
                        tag_max = _context2.sent;
                        reg = prefix + '([\\d\\' + delimiter + ']+)' + suffix;

                        version_now = new RegExp(reg).exec(tag_max)[1];
                        Log.log('The max version is', tag_max);
                        return _context2.abrupt('return', version_now);
    ...
    return function findVersion(_x2) {
            ...
            while (1) {
                switch (_context3.prev = _context3.next) {
                    case 0:
                        ...
                        suffix = '';
                        _context3.next = 4;
                        return findVersion('base');

                    case 4:
                        version_max = _context3.sent;
...
var process = __webpack_require__(123);
...
function baseVersion(type) {
    var version_new = '0.0.0',
        version_arr = version_max.split(delimiter);
    var major = parseInt(version_arr[0]) || 0;
    var minor = parseInt(version_arr[1]) || 0;
    var patch = parseInt(version_arr[2]) || 0;
    switch (type) {
        case 'major':
